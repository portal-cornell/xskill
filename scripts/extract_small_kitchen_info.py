...
write_json(
    f"{base_dev_dir}/xskill/small_datasets/kitchen_dataset/task_completions.json",
    task_completions_list,
)

# test read
read_json(f"{base_dev_dir}/xskill/small_datasets/kitchen_dataset/task_completions.json")
...
write_json(
    f"{base_dev_dir}/xskill/small_datasets/kitchen_dataset/eval_mask.json",
    eval_mask.tolist(),
)

train_mask = ~eval_mask
write_json(
    f"{base_dev_dir}/xskill/small_datasets/kitchen_dataset/train_mask.json",
    train_mask.tolist(),
)
